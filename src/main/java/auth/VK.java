...
public class VK {
    ...
    private String client_id="6477853";
    private String redirect_uri="http://localhost:8080/servlet/allStudents?type=vk";
    private String scope="users";
    private String version="5.74";
    private String client_secret="BKORGkVaahDwRP3wQzLZ";
